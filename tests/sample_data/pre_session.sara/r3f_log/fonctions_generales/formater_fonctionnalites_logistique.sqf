...
_infos = "<t align='left'>";
_infos = _infos + format ["<t font='RobotoCondensedBold'>Side:</t> %1<br/>", _side];

if (_places != 0) then {_infos = _infos + format ["<t font='RobotoCondensedBold'>Seats:</t> %1<br/>", _places]} else {_infos = _infos + "<br/>";};
_infos = _infos + "<br/>";
...
_infos = _infos + format ["<t font='RobotoCondensedBold'>Author:</t> %1<br/>", getText (configFile >> "CfgVehicles" >> _classe >> "author")];
_infos = _infos + format ["<t font='RobotoCondensedBold'>Faction:</t> %1<br/>", getText (configFile >> "CfgFactionClasses" >> (getText (configFile >> "CfgVehicles" >> _classe >> "faction")) >> "displayName")];
_infos = _infos + format ["<t font='RobotoCondensedBold'>Classname:</t> %1", configName (configFile >> "CfgVehicles" >> _classe)];
